...
class config_S560_NORMAL(config_LINUXINDOOR_NORMAL):

    def __init__(self, device_name=''):
        super().__init__(device_name)
        # Autop配置文件相关
        self._rename_cfg_file = 'S560reset.cfg'
        self._autop_cfg_file = 'r000000000560.cfg'
        self._old_firmware_file = 'S560.rom'
        self._firmware_ext = '.rom'
        self._model_name = 'S560'
        self._model_id_NORMAL = '560'
        self._oem = 'NORMAL'
        self._tln_or_ssh_pwd = ['I8+R)#ui6T2^t', 'yA@9^b8Zq-T+s']
        self._web_basic_upgrade_default_time = 180
