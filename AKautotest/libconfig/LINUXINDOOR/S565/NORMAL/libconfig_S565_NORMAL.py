...
class config_S565_NORMAL(config_LINUXINDOOR_NORMAL):

    def __init__(self, device_name=''):
        super().__init__(device_name)
        # Autop配置文件相关
        self._rename_cfg_file = 'S565reset.cfg'
        self._autop_cfg_file = 'r000000000565.cfg'
        self._old_firmware_file = 'S565.zip'
        self._firmware_ext = '.rom'
        self._model_name = 'S565'
        self._model_id_NORMAL = '565'
        self._oem = 'NORMAL'
