...
class config_E13_NORMAL(config_LINUXDOOR_NORMAL):
    """
    ...
    def __init__(self, device_name=''):
        ...
        # Autop配置文件相关
        self._rename_cfg_file = 'E13reset.cfg'
        self._autop_cfg_file = 'r0000000000013P.cfg'
        self._old_firmware_file = 'E13.rom'
        self._firmware_ext = '.rom'
        self._model_name = 'E13'
        self._model_id_NORMAL = '13'
        self._oem = 'NORMAL'
