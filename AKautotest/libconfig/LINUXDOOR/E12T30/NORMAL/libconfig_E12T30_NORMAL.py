...
class config_E12T30_NORMAL(config_LINUXDOOR_NORMAL):
    """
    ...
    def __init__(self, device_name=''):
        ...
        # Autop配置文件相关
        self._rename_cfg_file = 'E12T30reset.cfg'
        self._autop_cfg_file = 'r000000000012P.cfg'
        self._old_firmware_file = 'E12T30.rom'
        self._firmware_ext = '.rom'
        self._model_name = 'E12T30'
        self._model_id_NORMAL = '12'
        self._oem = 'NORMAL'
