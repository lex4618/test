...
class config_E12SV823_NORMAL(config_LINUXDOOR_NORMAL):
    """
    ...
    def __init__(self, device_name=''):
        ...
        # Autop配置文件相关
        self._rename_cfg_file = 'E12SV823reset.cfg'
        self._autop_cfg_file = 'r000000000012P.cfg'
        self._old_firmware_file = 'E12SV823.rom'
        self._firmware_ext = '.rom'
        self._model_name = 'E12SV823'
        self._model_id_NORMAL = '312'
        self._oem = 'NORMAL'
        self._remote_connect_type = 'ssh'
        self._button_dial_key = 'F'
