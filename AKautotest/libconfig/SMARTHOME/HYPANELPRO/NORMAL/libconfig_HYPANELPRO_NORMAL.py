...
class config_HYPANELPRO_NORMAL(config_NORMAL):

    def __init__(self, device_name=''):
        super().__init__(device_name)
        # 系列机型相关配置项
        self._product_model_name = 'HyPanel Pro'
        self._series_product_name = 'HYPANELPRO'
        ...
        self._cur_activity_use_u2 = False  # PS51机型uiautomator2框架无法使用app_current()方法获取activity，只能用dumpsys activity
