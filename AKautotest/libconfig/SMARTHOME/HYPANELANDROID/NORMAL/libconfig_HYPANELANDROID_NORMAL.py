...
class config_HYPANELANDROID_NORMAL(config_NORMAL):

    def __init__(self, device_name=''):
        super().__init__(device_name)
        # 系列机型相关配置项
        self._package_name = 'com.akubela.panel'
        self._product_model_name = 'HyPanel'
        self._series_product_name = 'HYPANELANDROID'
        ...
        self._screen_size = (480, 480)
        self._system_bar_rect = (0, 0, 480, 46)
