...
class config_KS53_NORMAL(config_HYPANELANDROID_NORMAL):

    def __init__(self, device_name=''):
        super().__init__(device_name)
        self._product_model_name = 'HyPanel KeyPlus'
        self._rename_cfg_file = 'KS53reset.cfg'
        self._autop_cfg_file = 'r000000000053.cfg'
        self._old_firmware_file = 'KS53.zip'
        self._firmware_ext = '.zip'
        self._model_name = 'KS53'
