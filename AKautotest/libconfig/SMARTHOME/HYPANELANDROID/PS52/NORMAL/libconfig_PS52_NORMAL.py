...
class config_PS52_NORMAL(config_HYPANELANDROID_NORMAL):

    def __init__(self, device_name=''):
        super().__init__(device_name)
        self._product_model_name = 'HyPanel Plus'
        self._rename_cfg_file = 'PS52reset.cfg'
        self._autop_cfg_file = 'r000000000052.cfg'
        self._old_firmware_file = 'PS52.zip'
        self._firmware_ext = '.zip'
        self._model_name = 'PS52'
        self._model_id_NORMAL = '52'
        self._oem = 'NORMAL'
