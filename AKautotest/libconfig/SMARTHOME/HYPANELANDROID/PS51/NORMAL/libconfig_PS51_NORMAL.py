...
class config_PS51_NORMAL(config_HYPANELANDROID_NORMAL):

    def __init__(self, device_name=''):
        super().__init__(device_name)
        # Autop配置文件相关
        self._product_model_name = 'HyPanel'
        self._rename_cfg_file = 'PS51reset.cfg'
        self._autop_cfg_file = 'r000000000051.cfg'
        self._old_firmware_file = 'PS51.zip'
        self._firmware_ext = '.zip'
        self._model_name = 'PS51'
        self._model_id_NORMAL = '51'
        self._oem = 'NORMAL'
