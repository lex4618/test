...
class config_KS41_NORMAL(config_HYPANELLINUX_NORMAL):

    def __init__(self, device_name=''):
        super().__init__(device_name)
        self._product_model_name = 'HyPanel Lite'
        self._product_type_name = 'PANEL'
        self._rename_cfg_file = 'KS41reset.cfg'
        self._autop_cfg_file = 'r000000000041.cfg'
        self._old_firmware_file = 'KS41.rom'
        self._firmware_ext = '.rom'
        self._model_name = 'KS41'
        self._model_id_NORMAL = '41'
        self._oem = 'NORMAL'
