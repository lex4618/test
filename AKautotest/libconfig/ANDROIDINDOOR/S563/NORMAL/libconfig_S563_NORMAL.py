...
class config_S563_NORMAL(config_ANDROIDINDOOR_NORMAL):

    def __init__(self, device_name=''):
        super().__init__(device_name)
        # Autop配置文件相关
        self._rename_cfg_file = 'S563reset.cfg'
        self._autop_cfg_file = 'r000000000563.cfg'
        self._old_firmware_file = 'S563.zip'
        self._firmware_ext = '.zip'
        self._model_name = 'S563'
        self._model_id_NORMAL = '563'
        self._oem = 'NORMAL'
        ...
        self._doorbell_event = 'sendevent /dev/input/event2 1 28 1;' \
