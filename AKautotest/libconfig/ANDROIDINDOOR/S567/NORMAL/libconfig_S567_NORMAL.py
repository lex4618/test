...
class config_S567_NORMAL(config_ANDROIDINDOOR_NORMAL):

    def __init__(self, device_name=''):
        super().__init__(device_name)
        # Autop配置文件相关
        self._rename_cfg_file = 'S567reset.cfg'
        self._autop_cfg_file = 'r000000000567.cfg'
        self._old_firmware_file = 'S567.zip'
        self._firmware_ext = '.zip'
        self._model_name = 'S567'
        self._model_id_NORMAL = '567'
        self._oem = 'NORMAL'
