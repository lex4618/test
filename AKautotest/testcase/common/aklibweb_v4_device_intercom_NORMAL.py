...
class web_v4_device_intercom_NORMAL(web_v4_device_NORMAL):
    ...
    # region Device - Display Setting页面
    ...
    # region Contacts - Local Contacts页面

    # region Contacts - Local Contacts页面 - All Contacts
    ...
    # region Contacts - Local Contacts页面 - BlockList
    ...
    # region Contacts - Local Contacts页面 - Contacts List Setting
    ...
    # region Arming-Zone Setting页面相关
    ...
    # region Upgrade Diagnosis页面 -> syslog模块
    ...
    # region Upgrade Diagnosis页面 -> PCAP模块
    ...
    # region Upgrade Diagnosis页面 -> Config导入导出模块
    ...
    # region Security Advanced页面，Service Location
